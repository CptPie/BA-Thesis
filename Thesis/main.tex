...
\thesistitle{Design and Implementation of a Just-In-Time Compiler for Smalltalk}
...
\group{\href{https://www.uni-bamberg.de/en/sysnap/}{Practical Computer Science, esp. Systems Programming}}
...
% uncomment to add the abstract to the table of contents (not recommended)
  This thesis outlines the design decisions and implementation details of a \jit{} (JIT) compiler for the Smalltalk-80 programming language and its virtual machine. It begins with a brief introduction to JIT compilation, followed by an explanation of the specific characteristics of Smalltalk-80.

The implementation discusses two open-source versions of a Smalltalk-80 interpreter, examining their designs and evaluating their advantages and disadvantages as a base of a JIT compiler. The development process ultimately led to a partially functional JIT compiler due to various challenges encountered throughout the project. The thesis explains the nature and causes of these issues and suggests potential solutions to prevent similar problems in the future.
\end{abstract}
...
Des Weiteren erkläre ich, dass Inhalt und Wortlaut der beiden Fassungen (digital/in Papierform) 
identisch sind und zur Kenntnis genommen wurde, dass die digitale Fassung einer durch 
Software unterstützten, anonymisierten Prüfung auf Plagiate unterzogen werden kann.
\bigskip
\bigskip
